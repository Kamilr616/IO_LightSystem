...
char old_c = '\0'; // Previously received character
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    if (c != old_c) {
      ...
      if (isValidInput) {
        switch (c) {
          case 'A':  // Thumb_Up: Green
            theaterChase(strip.Color(0, 255, 0), 50);
            break;
          case 'B':  // Thumb_Down: Purple
            theaterChase(strip.Color(128, 0, 255), 50);
            break;
          case 'C': // Open_Palm: Blue
            theaterChase(strip.Color(0, 0, 255), 50);
            break;
          case 'D': // Closed_Fist: Yellow
            theaterChase(strip.Color(255, 255, 0), 50);
            break;
          case 'E': // Victory: Spring green
            theaterChase(strip.Color(0, 255, 128), 50);
            break;
          case 'F': // Pointing_Up: Cyan
