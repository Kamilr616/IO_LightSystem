...
Projekt powstał jako **projekt z Inżynierii Oprogramowania**, początkowo osadzony wokół inteligentnego oświetlenia (europejska norma oświetlenia drogowego **PN-EN 13201**, wskazana w [odnośnikach zewnętrznych](docs/REFERENCES.pl.md), była pierwotną inspiracją) i ewoluował w to demo sterowania kolorem gestami. Był też jedną z inspiracji do pracy inżynierskiej **AI Sign Language Translator**.
...
| `docs/` | Dokumentacja projektu, zrzut ekranu i odnośniki zewnętrzne |
| `CHANGELOG.md` | Historia wydań |
| `THIRD_PARTY_NOTICES.md` | Komponenty podmiotów trzecich, zależności bezpośrednie i licencje |

## 🚀 Szybki start

### 1. Aplikacja Python

Użyj **Pythona 3.9–3.12**. Wydanie przypina MediaPipe `0.10.35`, udostępniający API rysowania Tasks wykorzystywane przez aplikację.
...
|-------|-----------|-----------|
| `--version` | Wyświetl wersję wydania aplikacji i zakończ | — |
